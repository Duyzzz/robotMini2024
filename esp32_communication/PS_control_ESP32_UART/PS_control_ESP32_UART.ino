...
//     short leftX = Ps3.data.analog.stick.lx;
//     short leftY = Ps3.data.analog.stick.ly;
//     int realX = (float)leftX/128*255;
//     int realY = (float)leftY/128*255;
//     if(leftX + leftY > 0 && leftX - leftY < 0 && abs(realY) > 20){
//         send(leftStickUpc, abs(realY));
//     } else if(leftX + leftY < 0 && leftX - leftY < 0 && abs(realX) > 20){
//         send(leftStickLeftc,  abs(realX));
//     } else if(leftX + leftY < 0 && leftX - leftY > 0 && abs(realY) > 20){
//         send(leftStickDownc,  abs(realY));
//     } else if(leftX + leftY > 0 && leftX - leftY > 0 && abs(realX) > 20){
//         send(leftStickRightc,  abs(realX));
//     }
// }
