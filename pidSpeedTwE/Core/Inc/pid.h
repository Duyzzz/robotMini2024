...
typedef struct {
    float x[3]; // Current and past inputs
    float y[3]; // Current and past outputs
...
float applySecondOrderFilter(SecondOrderFilter *filter, float input);
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Types ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
/* PID Mode */
